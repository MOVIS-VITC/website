...
export default function About() {
  ...
  const toggleHeight = () => {
    ...
    return (
      <section className="flex flex-col items-center font-poppins sm:mt-24 mt-12  overflow-hidden">
        
        <div className="text-5xl flex flex-col items-center  px-7 xl:px-0">
