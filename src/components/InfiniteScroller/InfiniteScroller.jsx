...
const InfiniteScroller = () => {   
  ...
  return (
    <div className='scroller flex flex-col items-start justify-start w-[100vw] overflow-hidden'>
      <div>
        <div className='scroller__inner flex py-2 gap-4 whitespace-nowrap w-full overflow-hidden'>
          {List.map((text, index) => {
