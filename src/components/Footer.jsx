        ...
        <div className="sm:mt-28 mt-12 w-full max-w-[1150px] flex flex-col sm:flex-row justify-between items-start xl:px-0 sm:px-16 px-7"> 
            ...
            <div className="basis-1/3 flex flex-col justify-between items-stretch lg:mr-20 sm:gap-8 gap-4">
                <div className="flex flex-col">
                    ...
                    <div className="xl:text-lg text-light font-medium">Homepage</div>
                    <div className="xl:text-lg text-light font-medium">About</div>
                    <div className="xl:text-lg text-light font-medium">Projects</div>
                    <div className="xl:text-lg text-light font-medium">Contact</div>
                </div>
                <div className="flex flex-col">
